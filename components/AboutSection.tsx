      ...
      <div className='flex' id='About'>
        ...
        <div className='px-2'>
          ...
          <p className='font-bold' style={{ fontSize: "18px" }}>
            Hacktoberfest is a global celebration of open-source software, and
          ...
          <p className='font-bold' style={{ fontSize: "18px" }}>
            ...
            hackathon, Hackovate 2023, in parallel to Hacktoberfest 2023.This
            ...
            Join us at Hackovate 2023, where coding meets creativity, and
            together, we{"'"}ll make a lasting impact on the world of
